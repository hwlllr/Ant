...
namespace LC.LS.DataAccess
{
    /// <summary>
    /// MySqlHelper操作类
    /// </summary>
    public sealed partial class MySqlDataAccess
    {
        public static readonly string DBConnectionString = ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString;
        /// <summary>
        /// 批量操作每批次记录数
        /// </summary>
        ...
        /// <param name="parms">查询参数</param>
        /// <returns>返回只读数据集</returns>
        public MySqlDataReader ExecuteDataReader(CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
